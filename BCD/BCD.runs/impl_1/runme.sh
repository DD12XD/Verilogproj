...
HD_PWD='C:/Users/debar/bcd_/bcd_.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segment.tcl -notrace
