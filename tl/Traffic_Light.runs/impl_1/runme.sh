...
HD_PWD='C:/Users/debar/Desktop/projcver/Traffic_Light/Traffic_Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_light.tcl -notrace
