...
HD_PWD='C:/Users/debar/Desktop/projcver/SR_flipflop/SR_flipflop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sr.tcl
