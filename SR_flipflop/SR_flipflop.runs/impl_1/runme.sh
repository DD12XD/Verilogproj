...
HD_PWD='C:/Users/debar/Desktop/projcver/SR_flipflop/SR_flipflop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sr.tcl -notrace
