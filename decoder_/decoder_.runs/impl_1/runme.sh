...
HD_PWD='C:/Users/debar/Decoder/Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decod.tcl -notrace
