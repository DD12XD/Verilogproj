...
HD_PWD='C:/Users/debar/Decoder/Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decod.tcl
