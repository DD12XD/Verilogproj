...
HD_PWD='C:/Users/debar/Desktop/projcver/Traffic_Light/Traffic_Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_light.tcl
